...
const code = `fig, ax = plt.subplots(figsize=(10, 10))
gdf.plot(column="soil_moisture", cmap="coolwarm")
plt.title("Soil Moisture Heatmap")
plt.savefig("logs/maps/soil_moisture.png")
plt.close()`

const tabs = [
  { name: 'soil_data.shp', isActive: true },
          ...
          <div className="relative z-10 md:text-center lg:text-left">
            ...
            <div className="relative">
              <p className="inline bg-gradient-to-r from-indigo-200 via-sky-400 to-indigo-200 bg-clip-text font-display text-5xl tracking-tight text-transparent">
                Planting Precision with Sorghum Science.
              </p>
              <p className="mt-3 text-2xl tracking-tight text-slate-400">
                Dive into a hands-on research experience to uncover the optimal
